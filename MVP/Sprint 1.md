...
- Início do planejamento e definição de indicadores a serem mostrados
- Começo das primeiras amostras de gráficos no dashboard

### Limitações conhecidas
- Alto número de dados com a possibilidade de perda de dados importantes
